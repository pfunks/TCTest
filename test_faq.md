...
Blockchains like Steem and Bitcoin produce new coins each time a block is generated. Unlike Bitcoin though, where all of the new coins go to block producers (often called miners), the Steem blockchain allocates a portion of the new tokens to the users.
