...
Blockchains like Steem and Bitcoin produce new coins each time a block is generated. Unlike Bitcoin though, where all of the new coins go to the block producers (often called miners), the Steem blockchain allocates a portion of the new tokens to pay the users for participation in the platform.

## How many new tokens are generated by the blockchain?

Since hardfork 16, the Steem blockchain started creating new tokens at a yearly inflation rate of 9.5%. The inflation rate decreases at a rate of 0.01% every 250k blocks, until it eventually reaches a rate of 0.95%. It will take approximately 20.5 years from the time hardfork 16 was implemented to reach 0.95%.
